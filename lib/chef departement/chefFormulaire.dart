...
class ChefFormulaire extends StatefulWidget {
  int _currentIndex = 0;
  ...
  @override
  State<ChefFormulaire> createState() => _ChefFormulaireState();
}

class _ChefFormulaireState extends State<ChefFormulaire> {
